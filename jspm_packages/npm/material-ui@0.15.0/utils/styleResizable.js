...
(function(process) {
  ...
  var warn = function warn() {
    process.env.NODE_ENV !== "production" ? (0, _warning2.default)(hasWarned, 'The \'material-ui/utils/styleResizable.js\' mixin has been deprecated.' + ' Please do not use this mixin as it will be removed in an upcoming release.') : void 0;
    hasWarned = true;
  };
  var Sizes = {
    SMALL: 1,
